...
#             (x_interior, levelSetMethodParam, x₀) = setupLevelSetMethod(ẑ, f_star_value; cutSelection = "ShrinkageLC", 
#                                                                                     Output_Gap = true, 
#                                                                                         ℓ1 = 0., # or 0   ## adjust x0
#                                                                                             ℓ2 = .5, ## adjust interior points
#                                                                                             λ = nothing);  
...
#     @everywhere begin 
#         function forwardParalllel(forward2Info::Forward2Info, randomVariables::RandomVariables, i::int64, ẑ;
#                                     indexSets::IndexSets = indexSets)
...
#             return JuMP.objective_value(forward2Info.model);
#         end
#     end
...
#                             );
#         ## stage 2
#         Stage2_collection = pmap(forwardParalllel, 
#                                     [forward2Info_List[ω] for ω in indexSets.Ω], 
#                                         [Ω_rv[ω] for ω in indexSets.Ω], 
#                                             [i for ω in indexSets.Ω],
#                                                 [ẑList[ω] for ω in indexSets.Ω]
#                                     )
