...
# Ω_rvList = load("src/testData/Ω_rvList2.jld2")["Ω_rvList"]


for Ω in [500]
  for i in 1:20 
    @info "$i"
      Ω_rv = Ω_rvList2[(Ω, i)]; indexSets.Ω = [1:Ω...];
      ...
      gurobiResultList[(Ω, i)] = gurobiOptimize!(indexSets, 
                                          ...
                                          Ω_rv,
                                          prob; 
                                          mipGap = 5e-2, timelimit = 10000); 
  end
  save("src/Experiments/ConfidenceInterval/gurobiResultList.jld2", "gurobiResultList", gurobiResultList)
end

save("src/Experiments/ConfidenceInterval/gurobiResultList.jld2", "gurobiResultList", gurobiResultList)

# gurobiResultList = load("src/Experiments/ConfidenceInterval/gurobiResultList.jld2")["gurobiResultList"]
