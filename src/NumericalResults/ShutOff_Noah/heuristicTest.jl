...
for alpha in keys(riskValueBasedPlan) 
    ...
    u = state_value + c;
    totalCost[alpha] = u;
    save("src/NumericalResults/ShutOff_Noah/totalCost.jld2", "totalCost", totalCost)
end

save("src/NumericalResults/ShutOff_Noah/totalCost.jld2", "totalCost", totalCost)

totalCost = load("src/NumericalResults/ShutOff_Noah/totalCost.jld2")["totalCost"]

save("src/NumericalResults/ShutOff_Noah/costDistribution.jld2", "costDistribution", costDistribution)
costDistribution = load("src/NumericalResults/ShutOff_Noah/costDistribution.jld2")["costDistribution"]
